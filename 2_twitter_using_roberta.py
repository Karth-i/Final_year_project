# -*- coding: utf-8 -*-
"""Twitter_Using_roberta.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ODJvjRT2WVUDpc03MCWLWtHvSUle5TJD
...
new_df = train[['text', 'airline_sentiment']]
...
class SentimentData(Dataset):
    def __init__(self, dataframe, tokenizer, max_len):
        ...
        self.targets = self.data.airline_sentiment.map({'positive': 0, 'neutral': 1, 'negative': 2})  # Map labels to integers
