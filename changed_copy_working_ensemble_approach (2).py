# -*- coding: utf-8 -*-
"""Changed_copy_Working_Ensemble_approach.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1utvlad4AtZ2yZ1F6gfqdyL74kGM2IYha
"""
...
class RobertaClass(torch.nn.Module):
    ...
    def forward(self, input_ids, attention_mask, token_type_ids):
        output_1 = self.l1(input_ids=input_ids, attention_mask=attention_mask, token_type_ids=token_type_ids)
        hidden_state = output_1[0]
        pooler = hidden_state[:, 0]  # Extracting the pooled representation
        pooler = torch.nn.Dropout(0.6)(pooler)  # Apply dropout directly
